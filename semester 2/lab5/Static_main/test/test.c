...
bool Test_InsertElement() {
    ...
    InsertElement(list, 1, 1, "RopeJam", 228, "Ranok", 0, 1);
...
bool Test_SortListByCriterion(){
    ...
    SortListByCriterion(list, comparePages , 1);
    ...
    SortListByCriterion(list, compareDv, 1);
    ...
    SortListByCriterion(list, compareName, 1);
    ...
    SortListByCriterion(list, comparePL, 1);
    ...
    SortListByCriterion(list, compareCover, 1);
    ...
    int main(){
        ...
        result &= Test_NewList();
        time_t end1 = clock();
        double whole_time1 = (double) (end1 - start1) / CLOCKS_PER_SEC;
        printf("time %f\n", whole_time1);
        if (result == true){
        ...
        time_t end2 = clock();
        double whole_time2 = (double) (end2 - start2) / CLOCKS_PER_SEC;
        printf("time %f\n", whole_time2);
        if (result == true){
            printf("Test result: succeed\n");
        }else{
        ...
        time_t end3 = clock();
        double whole_time3 = (double) (end3 - start3) / CLOCKS_PER_SEC;
        printf("time %f\n", whole_time3);
        if (result == true){
            printf("Test result: succeed\n");
        }else{
        ...
        time_t end4 = clock();
        double whole_time4 = (double) (end4 - start4) / CLOCKS_PER_SEC;
        printf("time %f\n", whole_time4);
        if (result == true){
            printf("Test result: succeed\n");
        }else{
